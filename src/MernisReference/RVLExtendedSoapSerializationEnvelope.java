...
public class RVLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RVLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RVLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RVLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RVLDateTimeConverter dateTimeConverter = new RVLStandardDateTimeConverter();

    public RVLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RVLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RVLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RVLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RVLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RVLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
