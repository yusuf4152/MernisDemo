...
public class RVLKPSPublicSoap
{
    ...
    public RVLKPSPublicSoap(){}

    public RVLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RVLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RVLExtendedSoapSerializationEnvelope envelope= new RVLExtendedSoapSerializationEnvelope(RVLExtendedSoapSerializationEnvelope.VER11);
